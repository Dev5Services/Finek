...
public class Traitement extends Service {
    ...
    private DocumentReference LastLocation = db.collection("users").document(user);
        ...
        listener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                for (String Area : listOfArea) {
                    ...
                    userRef.document(Area).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        @Override
